...
<html lang="pt-bt">
 <head>
	 ...
	 <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/toggle-menu.js"></script>
	 <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/scroll-menu.js"></script>
 ...
 <body <?php body_class(); ?> >
     <?php 
 	    //Chama o modal de informaçoes
 	    include('includes/organism/modal.php');

 	    //Chama o menu estatico
 	    include('includes/organism/menu-estatico.php');
     ?>
 	 <div class="homepg">
	     <div class="container">
	     	 <?php 
	     		//Chama a navegação responsiva
	     		include('includes/organism/navegacao-responsiva.php');

	     		//Chama a navegação padrão
	     		include('includes/organism/navegacao-padrao.php');
	     	 ?>	    
	     </div>
	     
	     <?php 
	     	//Chama o plano de fundo da pagina
	     	include('includes/atoms/bg.php'); 
	     ?>	          
 	 </div> 
     <main>
      <?php wp_head(); ?> 